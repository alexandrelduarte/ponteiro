...
export default async function Metodologia() {
  ...
  return (
    /* Recomposição desktop (ordem do dono): a página fala a MESMA língua do
       painel e do /historico — placas sobre a bruma, cabeçalho em duas colunas
       a partir de lg, e as seções de prosa em DUAS colunas de leitura dentro
       da placa (multicol com quebra proibida no meio de seção). A medida de
       cada parágrafo continua ≤ texto: largura se preenche com LAYOUT. */
    <main>
      <Secao>
        <Bloco rotuladoPor="titulo-metodologia">
          <div className="lg:grid lg:grid-cols-[minmax(0,34rem)_minmax(0,1fr)] lg:items-start lg:gap-10">
            <div>
              <h1 id="titulo-metodologia" className="text-pergunta text-tinta">
      ...
      <Secao>
        <Bloco>
          <SeletorMetodologia>
            <div className="mt-2 lg:columns-2 lg:gap-10 lg:[column-fill:balance] lg:[&>section]:mt-0 lg:[&>section]:mb-8">
              <BlocoMetodo
                id="medias"
                ...
                simples={
                  <p>
                    ...
                    para o dia da votação. A segunda carrega mais dúvida, porque até lá a corrida
                    ainda pode andar. A chance final soma os dois caminhos: ganhar já no 1º turno,
                    ou ganhar no 2º.
                  </p>
                }
              >
                <p>
                  Peso = recência (decaimento exponencial) × √(amostra/2000), teto 1,5. A
                  probabilidade “no cenário atual” usa a incerteza de hoje (dispersão entre
                  institutos + erro sistemático possível de todo o setor). A probabilidade “no dia
                  da votação” soma a deriva da opinião, que cresce com a raiz do tempo restante —
                  por isso ela é sempre menos cravada que a de hoje. A chance de eleição combina os
                  caminhos: vitória direta no 1º turno (mais de 50% dos válidos) ou vitória no 2º
                  turno.
                </p>
                <p>
                  As probabilidades são arredondadas para número inteiro e assim ficam. Casa decimal
                  em probabilidade de vitória é precisão falsa: uma variação de 1 ponto na
                  probabilidade corresponde a cerca de um décimo de ponto na intenção de voto
                  prevista.
                </p>
              </BlocoMetodo>
              ...
              <BlocoMetodo
                ...
                simples={
                  <p>
                    Para saber se a diferença subiu ou desceu, o painel compara cada instituto com
                    ele mesmo: a pesquisa nova contra a anterior da mesma casa, até 75 dias de
                    distância. Assim, diferença de método entre institutos não vira movimento falso.
                    Mudança menor que 0,8 ponto é tratada como “ficou igual”.
                  </p>
                }
              >
                <p>
                  Para evitar que diferenças de metodologia entre institutos virem “tendência”
                  falsa, o indicador compara cada instituto com ele mesmo: última rodada menos a
                  rodada anterior (até 75 dias), e tira a média desses pares. |Δ| menor que 0,8 p.p.
                  é tratado como estável. As linhas do gráfico são a média ponderada recalculada ao
                  longo do tempo.
                </p>
              </BlocoMetodo>
              ...
              <BlocoMetodo
                ...
                simples={
                  <p>
                    ...
                    <b className="font-semibold text-tinta">está em aberto</b>; de 60 a 75, na
                    frente por pouco; de 75 a 90, na frente; acima de 90, bem na frente — e nem aí é
                    garantia. Numa pesquisa isolada, empate técnico é quando a diferença é menor que
                    o dobro da{" "}
              ...
              >
                <p>
                  ...
                  favoritismo · 75–90% favorito · 90%+ amplamente favorito. Em cada pesquisa
                  isolada, “empate técnico” = diferença ≤ 2× a margem de erro. O modelo assume que
                  os dois primeiros colocados vão ao 2º turno — nas pesquisas atuais o 3º colocado
                  tem no máximo 8%.
                </p>
                <p>
              ...
              <BlocoMetodo
                ...
                simples={
                  <p>
                    ...
                    maquiagem, os pontos em que este painel pode errar — inclusive os que a gente
                    não tem como consertar.
                  </p>
                }
              >
                <p>
                  Pesquisas são retratos. Em 2022 parte dos institutos subestimou a votação da
                  direita — o erro sistemático do modelo existe por isso e é ajustável. O erro
                  sistemático padrão (4,0) é ancorado no estado não calibrado dos institutos: o
                  gabarito que reduziu o erro para +3,1 em 2022 — o resultado real do 1º turno — só
                  existirá depois de 04/10/2026. Cenários estimulados variam (lista de nomes,
                  presencial × telefone × on-line). Rodadas antigas de alguns institutos não
                  divulgaram o 1º turno ou o detalhe de brancos/nulos (marcadas n/d) — elas entram
                  só onde há dado. A Datafolha de julho não detalhou brancos/nulos do 1º turno,
                  então fica fora do cálculo de votos válidos do 1º turno.
                </p>
                <p>
                  Resultados de institutos diferentes não são estritamente comparáveis entre si:
                  método, lista de nomes e modo de coleta mudam. É por isso que a tendência é sempre
                  pareada e que o peso de cada rodada aparece na série, em vez de tudo virar uma
                  média anônima.
                </p>
              </BlocoMetodo>
              ...
              >
                <p>
                  Uma vez por dia, uma rotina no servidor consulta a web em busca de rodadas novas
                  dos institutos (posteriores à pesquisa mais recente da série), extrai os números
                  em formato estruturado e aplica checagens de sanidade: faixas plausíveis de
                  intenção de voto, coerência das datas, URL de fonte obrigatória e deduplicação por
                  instituto e data de campo.
                </p>
                <p>
                  O que essa rotina encontra{" "}
                  <b className="font-semibold text-tinta">não entra na série sozinho</b>: nasce como{" "}
                  <i>pendente</i> e só é publicado depois de aprovação humana, registrada em
                  auditoria pública — que você pode conferir na{" "}
                  <LinkInterno href="/historico" className="text-corpo">
                    lista do que já mudou
                  </LinkInterno>
                  . Não existe gatilho público de atualização: sem essa regra, qualquer pessoa
                  poderia forçar a entrada de uma rodada conveniente no momento conveniente.
                </p>
                <p>
                  O parâmetro de <b className="font-semibold text-tinta">viés direcional</b> é a
                  resposta quantitativa à pergunta “e se as pesquisas estiverem erradas de novo?”:
                  ele aplica ao agregado o padrão de erro observado em 2018 e 2022 (subestimação da
                  direita). Mover esse slider no painel muda todos os números da página, inclusive o
                  cenário-base — é assim que se vê que o “cenário mais provável” é função das
                  premissas, não um palpite.
                </p>
              </BlocoMetodo>
            </div>
            ...
            {/* As listas largas vivem na largura INTEIRA da placa (2 colunas de
              ~508px) — o recuo negativo que estourava a coluna morreu junto
              com a coluna única (recomposição desktop, DECISOES.md). */}
              ...
              <dl className="space-y-4 lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-10 lg:gap-y-4 lg:space-y-0">
                {ORDEM_GLOSSARIO.map((chave) => (
                  <div key={chave}>
                    ...
                    <dd className="mt-1 max-w-texto text-corpo text-tinta-media numeros">
