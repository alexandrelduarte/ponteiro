...
import { GLOSSARIO, ORDEM_GLOSSARIO } from "@/components/ui/textos";
...
function BlocoMetodo({
  ...
  return (
    <Secao>
      <Bloco rotuladoPor={id}>
        <Pergunta id={id}>{titulo}</Pergunta>
        <div className={`mt-2 max-w-texto text-corpo text-tinta-media ${SO_SIMPLES}`}>
          {simples}
        </div>
        {children ? (
    ...
    <main>
      ...
      <SeletorMetodologia>
        <BlocoMetodo
          ...
          simples={
            <p>
              Cada pesquisa entra na média com um peso: mais nova e com mais gente ouvida pesa mais.
              Depois o painel calcula duas chances — uma se a votação fosse hoje e outra para o dia
              da votação. A segunda carrega mais dúvida, porque até lá a corrida ainda pode andar. A
              chance final soma os dois caminhos: ganhar já no 1º turno, ou ganhar no 2º.
            </p>
          }
        >
          <p>
            ...
            sistemático possível de todo o setor). A probabilidade «no dia da votação» soma a deriva
            da opinião, que cresce com a raiz do tempo restante — por isso ela é sempre menos
            cravada que a de hoje. A chance de eleição combina os caminhos: vitória direta no 1º
            turno (mais de 50% dos válidos) ou vitória no 2º turno.
          </p>
          <p>
        ...
        <BlocoMetodo
          ...
          simples={
            <p>
              ...
              pouco; de 75 a 90, na frente; acima de 90, bem na frente — e nem aí é garantia. Numa
              pesquisa isolada, empate técnico é quando a diferença é menor que o dobro da folga da
              medida.
            </p>
          }
        >
          ...
          <p>
            A régua acima é publicada de propósito e usada literalmente: o título do veredito nunca
            usa uma palavra que não esteja nesta tabela. Palavras carregam probabilidade implícita,
            e cada leitor calibra a sua — então a nossa fica à vista.
          </p>
        </BlocoMetodo>
        ...
        <BlocoMetodo
          ...
          simples={
            <p>
              Pesquisa é uma foto do momento, e foto sai errada às vezes. Aqui estão, sem maquiagem,
              os pontos em que este painel pode errar — inclusive os que a gente não tem como
              consertar.
            </p>
          }
        >
          <p>
            Pesquisas são retratos. Em 2022 parte dos institutos subestimou a votação da direita — o
            erro sistemático do modelo existe por isso e é ajustável. O erro sistemático padrão
          ...
          <p>
            ...
            lista de nomes e modo de coleta mudam. É por isso que a tendência é sempre pareada e que
            o peso de cada rodada aparece na série, em vez de tudo virar uma média anônima.
          </p>
        </BlocoMetodo>
        ...
        >
          <p>
            ...
            institutos (posteriores à pesquisa mais recente da série), extrai os números em formato
            estruturado e aplica checagens de sanidade: faixas plausíveis de intenção de voto,
            coerência das datas, URL de fonte obrigatória e deduplicação por instituto e data de
            campo.
          </p>
          <p>
          ...
          <p>
            O parâmetro de <b className="font-semibold text-tinta">viés direcional</b> é a resposta
            quantitativa à pergunta «e se as pesquisas estiverem erradas de novo?»: ele aplica ao
            agregado o padrão de erro observado em 2018 e 2022 (subestimação da direita). Mover esse
            slider no painel muda todos os números da página, inclusive o cenário-base — é assim que
            se vê que o «cenário mais provável» é função das premissas, não um palpite.
          </p>
        </BlocoMetodo>
        ...
        <BlocoMetodo
          ...
          simples={
            <p>
              São as mesmas explicações que abrem quando você toca num chip no painel, reunidas aqui
              em uma página só.
            </p>
          }
        >
            ...
            <ul className="mt-2 text-micro numeros">
              {fontes.map((p) => (
                ...
                >
                  ...
                  <span className="whitespace-nowrap text-tinta-media">{p.tse}</span>
                </li>
              ))}
            </ul>
          </Bloco>
