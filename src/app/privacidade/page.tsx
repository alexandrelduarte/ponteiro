  ...
  return (
    <main className="mx-auto w-full max-w-pagina px-goteira md:px-goteira-md lg:px-goteira-lg">
      <div className="mx-auto max-w-texto pt-respiro md:pt-respiro-md">
        <header>
          <h1 className="text-pergunta text-tinta">Privacidade</h1>
        ...
        <SecaoProsa id="o-que-nao-existe" titulo="O que não existe aqui">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              <b className={B}>Sem venda ou compartilhamento de dados</b> com quem quer que seja.
            </li>
            <li>
              <b className={B}>Sem rastreamento entre sites:</b> o que você faz fora daqui não nos
              interessa.
            </li>
          </ul>
        </SecaoProsa>
        ...
        <SecaoProsa id="audiencia" titulo="Como medimos a audiência">
          <p>
            ...
            <b className={B}>agregada e sem cookie</b>: contamos acessos, páginas vistas e origem do
            tráfego. Um identificador temporário, derivado da visita, se descarta diariamente.
            Nenhum visitante é identificado individualmente.
          </p>
          <p>
            Base legal: legítimo interesse (art. 7º, IX, da LGPD — Lei 13.709/2018) em saber quantas
            pessoas usam o site e o que leem, sem identificar ninguém.
          </p>
        </SecaoProsa>

        <SecaoProsa id="o-que-e-tratado" titulo="O que é tratado, afinal">
          <p>
            <b className={B}>Logs de infraestrutura</b>: endereço IP, tipo de navegador e horário de
            acesso, gerados automaticamente pela Vercel e pelo Supabase — as plataformas que servem
            o site. Servem para segurança e estabilidade: detectar ataque, abuso e falha.
          </p>
          <p>
            A retenção segue o prazo padrão dessas plataformas. Esses registros só são fornecidos a
            terceiros por <b className={B}>ordem judicial</b> (art. 15, § 3º, do Marco Civil da
        ...
        <SecaoProsa id="cookies" titulo="Cookies">
          <p>
            Existe um único cookie no site: o <b className={B}>cookie de sessão</b> que mantém os
            dois administradores autenticados na área restrita (/admin). Para o público, nenhum — e
            é por isso que não há banner de cookies.
          </p>
        </SecaoProsa>

        <SecaoProsa id="pessoas-publicas" titulo="Conteúdo sobre pessoas públicas">
          <p>
            O site publica números de candidatos à Presidência, a partir de pesquisas registradas no
            TSE. Esse tratamento tem <b className={B}>fim jornalístico</b> (art. 4º, II,
            &ldquo;a&rdquo;, da LGPD) e, por isso, fica fora do escopo material da lei.
          </p>
        </SecaoProsa>
        ...
        <SecaoProsa id="operadores" titulo="Quem opera a infraestrutura">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              <b className={B}>Supabase</b> — banco de dados e login dos administradores (região São
              Paulo).
            </li>
            <li>
        ...
        <SecaoProsa id="seus-direitos" titulo="Seus direitos">
          ...
          <p>
            ...
            : por ora, <LinkExterno href={ISSUES}>uma issue no repositório do GitHub</LinkExterno>;
            um e-mail dedicado entra em breve.
          </p>
          <p>
            O PONTEIRO se enquadra como <b className={B}>agente de tratamento de pequeno porte</b>{" "}
            (Resolução CD/ANPD nº 2/2022): as obrigações formais são as simplificadas dessa norma, e
            os seus direitos valem por inteiro.
          </p>
        </SecaoProsa>
